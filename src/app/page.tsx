      ...
      <section className="hero">
        <div className="container hero-grid">
          <div>
            ...
            <p>
              GDGoC CNU에서 진행되는 이벤트, 스터디, 프로젝트, 챌린지를 한눈에
              확인하고 참여할 수 있는 공식 홈페이지입니다. Firebase와 Gemini를
              활용한 실제 작동 데모를 중심으로 발전시킵니다.
            </p>
          ...
          <aside className="poster-panel" aria-label="Build with AI demo">
            ...
            <strong>Gemini가 초안을 다듬고 Firebase가 활동을 저장합니다.</strong>
            <p>
        ...
        <div className="container">
          <div className="section-header">
            <div>
              ...
              <p>외부 방문자에게 공개 가능한 최근 활동과 캠페인입니다.</p>
            </div>
          </div>
      ...
      <section className="section">
        <div className="container grid grid-3">
          <div className="card">
            ...
            <p>로그인, 활동 등록, 멤버 홈 반영 흐름을 실제 데이터 경로로 연결합니다.</p>
          </div>
          <div className="card">
            <span className="badge">Gemini</span>
            <h3>운영진 글쓰기 보조</h3>
            <p>거친 메모에서 카드 요약, 멤버용 문구, 공개용 문구를 제안합니다.</p>
          </div>
          <div className="card">
            <span className="badge badge-green">Community</span>
            <h3>활동을 한눈에</h3>
            <p>공지와 활동을 구조화해서 멤버의 참여율과 소속감을 높입니다.</p>
          </div>
        </div>
      </section>
    </main>
